...
import main.java.employee.productsControllerEmployee;
...
public class InitializerController implements Initializable {
    ...
    public String sessionUser = LogInController.loggerUsername; //This field will hold userName whose currently using the system
    ...
    class LoadRecords extends Task {
        ...
        protected Object call() throws Exception {
            ...
            //Setting Id and Name to SalesController, RentalsController, Accounts
            SalesController.customerIDName = customerIDNameHolder;
            SalesController.customerID = customerID;
            ...
            //Setting Observable Lists to the static field of productsControllerEmployee
            productsControllerEmployee.itemList = itemList;
            productsControllerEmployee.itemNames = itemNames;
            SalesController.inventoryItem = itemIDNameForSale; //Setting item id and name for sale & RentalsController
            SalesController.itemIDForSale = itemIDForSale;
            ...
            SalesController.purchaseList = sellsListByUser;
            ...
            //Updating Task Message
            //DashboardControllerBoth contents
            ...
            //Setting on DashboardControllerBoth

            DashboardControllerBoth.stockOut = stockOutCtr;
            ...
            productsControllerEmployee.itemType = itemTypeTree;
            productsControllerEmployee.itemTypeName = itemTypeName;
