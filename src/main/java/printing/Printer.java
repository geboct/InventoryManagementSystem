...
public class Printer {
    ...
    public Printer(JasperPrint jasperPrint, String printerName) throws JRException {
...
//Lets set the printer name based on the registered printers driver name
        ...
        if(selectedService != null)
        {
            try{
                ...
                JasperExportManager.exportReportToPdfFile(jasperPrint, "E:\\fail-to-print.pdf");
                e.printStackTrace();
            } catch (Exception e) {
                e.printStackTrace();
            }
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, "E:\\damnit-fail-to-print.pdf");
            return;
        }
